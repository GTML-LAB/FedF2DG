...
import numpy as np
from torchvision.datasets import MNIST,  SVHN, FashionMNIST, CIFAR100, ImageFolder, DatasetFolder, utils
...
class FashionMNIST_truncated(data.Dataset):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None, download=False, noise_type=None, noise_rate=0.2):
